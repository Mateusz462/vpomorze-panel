...
if (!empty($_SESSION['id'])) {
	ograniczenia_logout($_SESSION['id']);
...
<html lang="pl">
<?php
	require_once "dist/themapart/header.php";
	if(empty($user['id'])):
?>
	<body style="background-size: cover; background-image: url('https://cdn.discordapp.com/attachments/793594679810588712/854807317659910215/v89lxrH.jpg');">
		<div class="container">
				...
				<div class="col-xl-6 col-lg-6 col-md-9">
					<div class="card o-hidden border-0 shadow-lg my-5">
						<div class="card-body p-0">
							...
							<div class="row">
								<div class="col-lg-12">
									<?php if (empty($_GET) || !isset($_GET['a'])) $_GET['a'] = 'login';
										switch($_GET['a'])
			...
			<?php
				require_once "dist/themapart/script.php";
			?>
		</div>
	</body>
<?php
...
?>
	<body id="page-top">
		<!-- Page Wrapper -->
		<div id="wrapper">
			<?php require_once "dist/themapart/sidebar.php";?>
			<div id="content-wrapper" class="d-flex flex-column">
				<div id="content">
					<?php require_once "dist/themapart/navbar.php";?>
					<div class="container-fluid">
						<?php
							...
							switch($_GET['a']) { // Funkcja wybierania pliku do załadowania
								...
								case 'profile': require_once('strony/profile-user.php'); break; // Strona kontaktowa
								...
								case 'wykaz-nowy': require_once('strony/wykaz1.php'); break; // Strona z listą pracowników
								...
								case 'zarzadzanie-grafik': require_once('strony/zarząd/zarzadzanie-grafik.php'); break; // Strona z listą pracowników
								case 'zarzadzanie-raporty': require_once('strony/zarząd/zarzadzanie-raporty.php'); break; // Strona z listą pracowników
								case 'zarzadzanie-faq': require_once('strony/zarząd/faq.php'); break; // Strona z listą pracowników
								case 'zarzadzanie-dokumentacja': require_once('strony/zarząd/dokumentacja.php'); break; // Strona z listą pracowników
								case 'zarzadzanie-pobieralnia': require_once('strony/zarząd/pobieralnia.php'); break; // Strona z listą pracowników
								case 'zarządzanie-urlopy': require_once('strony/zarząd/zarzadzanie-urlopy.php'); break; // Strona z listą pracowników
								case 'wnioskioprace-zarządzanie': require_once('strony/zarząd/wnioskioprace.php'); break; // Strona z listą pracowników

								//wnioski
								case 'flota-wnioski': require_once('strony/zarząd/flota-wnioski.php'); break; // Strona z listą pracowników
								case 'dyspozytornia-wnioski': require_once('strony/zarząd/kzw-wnioski.php'); break; // Strona z listą pracowników
								case 'kadry-wnioski': require_once('strony/zarząd/flota-wnioski.php'); break; // Strona z listą pracowników
								...
								//administracja
								case 'zarzadzanie-wnioski': require_once('strony/zarząd/wnioski.php'); break; // Strona z listą pracowników
								case 'zarządzanie-przewoznicy': require_once('strony/zarząd/przewoznicy.php'); break; // Strona z listą pracowników
				...
				<?php require_once "dist/themapart/footer.php";?>
				<?php cookie_info();?>
			</div>
		</div>
		...
		<?php require_once "dist/themapart/script.php";?>
	</body>
<?php
	endif;
?>
