<?php
	if($perm['zarzadzanie_wnioskami_kzw'] == '0'){
			...
			if(empty($_POST['uwagi'])){
				...
				if($query){
					...
					if($client){
						...
						header('Location: index.php?a=wnioski-zarządzanie');
					} else{
			...
			<div class="row">
				<?php if($strona1):?>
					<div class="col-lg-12">
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<h3 class="m-0 font-weight-bold">Wnioski KzW oczekujące na rozpatrzenie</h3>
							</div>
							<!-- /.card-header -->
									...
									<tbody >
										<?php
											...
											<tr>
												...
												<?php
													if($row['status'] == 0){
														echo '<td><b style="color: #cccc00">Oczekuje na sprawdzenie</b></td><td class="project-actions "><a href="index.php?a=kzw-wnioski&edit='.$row['id'].'"><button type="button" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i> Wybierz</button></a></td>';
													} elseif($row['status'] == 1){
														echo '<td><b style="color: #009900">Zaliczony</b></td><td class="project-actions ">
														<a href="index.php?a=wnioski-zarządzanie&view='.$row['id'].'"><button type="button" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i> Wybierz</button></a></td>';
													} elseif($row['status'] == 2){
					...
					<div class="col-lg-12">
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<h3 class="m-0 font-weight-bold">Wnioski KzW rozpatrzone</h3>
							</div>
							<!-- /.card-header -->
							<div class="card-body table-responsive">
								<table class="dataTable table table-bordered text-center">
									...
									<tbody >
										<?php
											...
											<tr>
												...
												<?php
													if($row['status'] == 0){
														echo '<td><b style="color: #cccc00">Oczekuje na rozpatrzenie</b></td><td class="project-actions "><a href="index.php?a=kzw-wnioski&edit='.$row['id'].'"><button type="button" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i> Wybierz</button></a></td>';
													} elseif($row['status'] == 1){
														echo '<td><b style="color: #009900">Rozpatrzony pozytywnie</b></td><td class="project-actions ">
														<a href="index.php?a=kzw-wnioski&view='.$row['id'].'"><button type="button" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i> Wybierz</button></a></td>';
													} elseif($row['status'] == 2){
							...
							<div class="card-body">
								<div class="row">
									...
									<div class="col-12 col-xl-6">
										...
										<a href="index.php?a=kzw-wnioski&edit=<?=$id?>&add=true" class="btn btn-success btn-block">Przyjmnij wniosek</a>
	...
	<div id="delete" class="modal fade" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<form action="index.php?a=kzw-wnioski&edit=<?=$id?>&delete=true" method="POST">
