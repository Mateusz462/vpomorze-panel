<?php
	...
	require("./skrypty/generator.php");
	$mail = new PHPMailer\PHPMailer\PHPMailer();
	if	(isset($target['pojazd'])){
			$target = row("SELECT * FROM tabor WHERE id = ".$target['pojazd']);
	}
	if (!isset($_GET['edit']) && !isset($_GET['view'])) {
		...
		$poj = row("SELECT * FROM tabor WHERE id= ".$poj['id']);
		if(!empty($_POST)){
			...
			<div class="row">
				<?php if($strona1):?>
					<div class="col-lg-12">
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<h3 class="m-0 font-weight-bold text-primary">Wnioski oczekujące na sprawdzenie</h3>
							</div>
							<!-- /.card-header -->
							<div class="card-body table-responsive">
								<table class="dataTable table table-bordered text-center">
									<?php
										$targets = call("SELECT * FROM wnioski WHERE status = 0");
									...
									<tbody >
										<?php
											...
											<tr>
												...
												<?php
													if($row['status'] == 0){
														echo '<td><b style="color: #cccc00">Oczekuje na sprawdzenie</b></td><td class="project-actions "><a href="index.php?a=wnioski-zarządzanie&edit='.$row['id'].'"><button type="button" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i> Wybierz</button></a></td>';
													} elseif($row['status'] == 1){
					...
					<div class="col-lg-12">
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<h3 class="m-0 font-weight-bold text-primary">Wnioski sprawdzone</h3>
							</div>
							<!-- /.card-header -->
							<div class="card-body table-responsive">
								<table class="dataTable table table-bordered text-center">
							...
							<div class="card-body">
								<div class="row">
										...
										<?php elseif($target['typ'] == 5):?>
											<div class="row">
												<div class="col-12">
													<ul class="list-group list-group-unbordered mb-3">
														<li class="list-group-item">
															<b>Pojazd</b><span class="float-right"><?=$row['pojazd'];?></span>
														</li>
														<li class="list-group-item">
									...
									<div class="col-12 col-xl-6">
										...
										<a href="index.php?a=wnioski-zarządzanie&edit=<?=$id?>&add=true" class="btn btn-success btn-block">Przyjmnij wniosek</a>
	...
	<div id="delete" class="modal fade" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<form action="index.php?a=wnioski-zarządzanie&edit=<?=$id?>&delete=true" method="POST">
